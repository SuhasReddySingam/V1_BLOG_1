...
const HomePage = () => {
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Welcome to Blogger the best AI blog gen website</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">With the rapid rise in the capabilites of AI they have been adapted to perform a number of tasks including writing blogs.</p>
			<Link to={"/create"}>
			<motion.button
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Why should you use Blogger?</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">It doesn't matter if you are an aspiring blogger or a company looking to iuncrease your customer base using AI to write blogs is beneficial for everyone</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">Plan it, create it, launch it. Create blogs of high quality that are sure to get you business more attention.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Automate the writing so you can focus on more important tasks.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Individual</h3>
              <p class="text-gray-500 dark:text-gray-400">It doesn't matter if you are writing as a hobby or on a professional level using our AI blog writer can make ypur life much easier by taking out all the hard parts of writing like coming up with a structure for your blog.</p>
          </div>
      </div>
  </div>
</section>
    ...
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.linkedin.com/in/suhas-reddy-28a796320/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/s_suhas_reddy/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://github.com/SuhasReddySingam/V1_BLOG_1" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
