  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div>
              ...
              <p class=" text-gray-400">It doesn't matter if you are writing as a hobby or on a professional level using our AI blog writer can make ypur life much easier by taking out all the hard parts of writing like coming up with a structure for your blog.</p>
          </div>
      </div>
  </div>
</section>
